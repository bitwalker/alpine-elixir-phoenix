...
It is based on my `alpine-erlang` image, and installs Elixir (1.6.5), Node.js (6.10.x), Hex and Rebar. It can handle compiling
...
```dockerfile
FROM littkekidogo/alpine-elixir-phoenix:latest
